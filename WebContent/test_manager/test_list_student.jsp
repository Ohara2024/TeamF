...
<jsp:include page="/scoremanager/main/header.jsp"></jsp:include>
<jsp:include page="/scoremanager/main/side_menu.jsp"></jsp:include>
...
<jsp:include page="/scoremanager/main/footer.jsp"></jsp:include>
<%-- 一応使わない --%>